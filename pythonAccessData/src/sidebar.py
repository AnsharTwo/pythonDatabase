...
class SIDEBAR:
    ...
    def init_sidebars(self):
        ...
        st.sidebar.title("Edit data manager")
        dropSelectApp = st.sidebar.selectbox("Select to do", ["None",
                                                              self.dict_edit_data_app.get("annotDb"),
                                                              self.dict_edit_data_app.get("urlExcel")])
        if dropSelectApp == self.dict_edit_data_app.get("annotDb"):
            editForm.select_edit_form()
        elif dropSelectApp == self.dict_edit_data_app.get("urlExcel"):
